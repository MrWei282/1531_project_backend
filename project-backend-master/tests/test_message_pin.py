...
def setup():
    users = []
    users.append(register_user('czt1@email.com', 'abc1234', 'zhitao', 'chen'))
    users.append(register_user('czt2@email.com', 'abc1234', 'linbo', 'zhang'))
    users.append(register_user('czt3@email.com', 'abc1234', 'tianyu', 'wei'))
